        ...
        <div className="glass-card p-12 sm:p-16 text-center space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base-content/60 text-lg max-w-md mx-auto leading-relaxed">
              We are preparing something truly special. Guided meditation sessions, breathwork classes, and yoga workshops — all with live Google Meet integration.
            </p>
          </div>
