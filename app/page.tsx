...
const ProfilePicture = () => {
  return (
    <img src="/self.png" alt="Profile picture of Bidyadhar" className="bg-gradient-to-br from-indigo-500 to-fuchsia-500 rounded-full w-[300px] md:w-2/5 p-3" />
  )
}
...
const BulletPoints = () => {
  return (
    <ul className="space-y-1 text-xl text-center md:text-left">
      ...
      <li>📝download my <a className="link link-primary" href="/BidyadharResume.pdf" download="BidyadharResume">resume</a></li>
    </ul>
  )
}
